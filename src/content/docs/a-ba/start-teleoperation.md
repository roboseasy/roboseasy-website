...
<br>자세한 방법은 [A-Ba(SO-ARM101) 캘리브레이션 가이드](#/software-calibration) 참고.
...
A-Ba(SO-ARM101) 두 대를 Ubuntu에서 USB로 연결한 환경 기준 예시입니다.
